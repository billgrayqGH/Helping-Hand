                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    <form action="<?php echo base_url('index.php/welcome/create_con');?>" method="post" role="form">
                                        ...
                                        <div class="form-group">
                                            <label>Address</label>
                                            <textarea class="form-control" name="contactaddress" rows="3" placeholder="Enter Address"></textarea>
                                        </div>
                                        <div class="box-footer">
                                         <?php echo validation_errors();?>  
                                        <button type="submit" class="btn btn-primary">Add</button>
                                        <button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo base_url('index.php/welcome/vdcon');?>'">Back</button>
                                        </div>
                                    </form>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
