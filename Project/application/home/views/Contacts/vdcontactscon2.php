                                        ...
                                        <tbody>
                                         ...
                                         <?php foreach($volunteer_info as $row)  
                                            ...
                                            <?php    echo '<td>'. $row['volID'].'</td>'; ?>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-default" onclick="window.location.href='<?php echo base_url('index.php/welcome/econ2');echo '/'.$row['contactID'];?>'"><i class='fa fa-pencil-square-o'></i> Edit</button>
