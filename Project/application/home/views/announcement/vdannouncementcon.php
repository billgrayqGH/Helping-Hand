                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                               <?php
                                            $query = $this->db->query('SELECT announcementID, announcementTitle, announcementDesc , volID FROM org_announcement');
                                            ...
                                            <?php    echo '<td>'. $row['volID'].'</td>';?>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-default" onclick="window.location.href='<?php echo base_url('index.php/welcome/eann'); echo '/'.$row['announcementID'];?>'"><i class='fa fa-pencil-square-o'></i> Edit</button>
