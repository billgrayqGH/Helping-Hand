...
<html>
    <head>
        ...
        <!-- start: CSS -->
	<link id="bootstrap-style" href="http://localhost/Project/designs/account/css/bootstrap.min.css" rel="stylesheet">
	<link href="http://localhost/Project/designs/account/css/bootstrap-responsive.min.css" rel="stylesheet">
	<link id="base-style" href="http://localhost/Project/designs/account/css/style.css" rel="stylesheet">
	<link id="base-style-responsive" href="http://localhost/Project/designs/account/css/style-responsive.css" rel="stylesheet">
